...
Revision ID: 69dc2fd8d8d5
Revises: 73a7d006cd2e
Create Date: 2025-07-06 14:41:42.019569
...
revision: str = '69dc2fd8d8d5'
down_revision: Union[str, Sequence[str], None] = '73a7d006cd2e'
...
def upgrade() -> None:
    ...
    sa.Column('date_joined', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
