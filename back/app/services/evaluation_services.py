...
class EvaluationService:
    ...
    def get_evaluations(self) -> List[EvaluationRead]:
        ...
        try:
            evaluation_models = self.__unit_of_work.evaluations.list()
    ...
    def get_evaluations_paginated(self, pagination: CustomPagination):
        ...
        try:
            total_count = self.__unit_of_work.evaluations.count()
            paginated_models = self.__unit_of_work.evaluations.list_paginated(
    ...
    def get_evaluation(self, evaluation_id: int) -> Optional[EvaluationRead]:
        ...
        try:
            ev_model = self.__unit_of_work.evaluations.get(evaluation_id)
            if ev_model is None:
    ...
    def create_evaluation(self, evaluation_data: EvaluationCreate) -> EvaluationRead:
        ...
        try:
            ...
            created_model = self.__unit_of_work.evaluations.add(evaluation_create)
    ...
    def delete_evaluation(self, evaluation_id: int) -> bool:
        ...
        try:
            success = self.__unit_of_work.evaluations.delete(evaluation_id)
            if success:
                self.__unit_of_work._UnitOfWork__session.commit()
